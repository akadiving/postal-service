...
urlpatterns = [
    ...
    path('items/filter-by-date/', filter_by_date, name='filter-by-date'),
    ...
    path('items/generate_sticker/<int:pk>', Generate_sticker, name='generate-sticker'),
    ...
    path('items/upload-excel/', upload_excel, name="upload-excel"),
    path('items/stickers/', stickers, name='stickers'),
    path('items/get-excel/', get_excel, name='get-excel'),
